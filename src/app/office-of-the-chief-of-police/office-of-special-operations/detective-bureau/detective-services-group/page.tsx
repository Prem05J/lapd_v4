  ...
  return (
    <div>
      ...
      <Box sx={{ display: 'flex', padding: '32px 0px', flexDirection: 'column', background: '#0f212b' }}>
        <Container>
          <Typography className={global.fadeInUp} sx={{ color: '#fff', margin: '0px 0px 20px', fontSize: mobile ? '40px' : '60px', fontWeight: '700' }}>Detective Services Group</Typography>
        </Container>
      </Box>


      <Container>
        <Box sx={{ padding: "40px 0% 40px 0%" }}>
          <Grid container>
