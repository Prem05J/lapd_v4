    ...
    return (
        ...
        <>
            <Box sx={{ display: 'flex', padding: '32px 5%', flexDirection: 'column', background: '#0f212b' }}>
                <Typography sx={{ marginBottom: '8px', color: '#fff', fontSize: mobile ? '18px' : '22px' }}>Chief Michel Moore</Typography>
                <Typography sx={{ color: '#fff', margin: '0px 0px 20px', fontSize: mobile ? '30px' : '62px', fontWeight: '700' }}>Office of the Chief of Police</Typography>
                <Link style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }} href='https://www.lapdonline.org/office-of-the-chief-of-police-ocop/'>
