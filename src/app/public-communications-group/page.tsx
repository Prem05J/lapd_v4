...
const PublicCommunication = () => {
  ...
  return (
    <div>
      ...
      <Container>
        <Box className={global.fadeInUp} sx={{ display: "flex", flexDirection: "column", gap: "30px", marginTop: "60px" }}>
          <Box>
          ...
          <Grid container>
            <Grid className={styles.link} item sm={12} md={9.5} xl={8.5}>
          ...
          <Box sx={{ marginTop: "30px" }}>
            <Typography sx={{ fontSize: mobile ? '30px' : '40px', fontWeight: "bold" }}>Facts About MRS</Typography>
