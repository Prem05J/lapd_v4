...
const PoliceCommission = () => {
    ...
    return (
        <>
            <Box sx={{ display: 'flex', padding: "28px 0px", flexDirection: 'column', background: '#0f212b' }}>
                <Container>
                    <Typography className={global.fadeInUp} sx={{ color: '#fff', fontSize: mobile ? '18px' : '22px' }}>Under the City Charter, the Board of Police Commissioners is the head of  the <br /> Police Department.</Typography>
            ...
            <Container>
                <Box className={global.fadeInUp} sx={{ marginTop: "50px" }}>
                    <Grid container rowSpacing={7} columnSpacing={5}>
                        ...
                        <Grid item xs={12} sm={5}  >
                            ...
                            <Image className={styles.commissionImage} src={commissionImage} alt="commission-image" />
                        </Grid>
                    </Grid>
            ...
            <Grid className={global.fadeInUp} container >
                <Box sx={{ display: 'flex', width: "100%", flexDirection: 'column', background: '#0f212b', padding: '28px 0px', marginTop: "30px" }}>
                    <Container>
            ...
            <Container>
                ...
                <Box className={global.fadeInUp} sx={{ paddingTop: "60px" }}>
                    ...
                    <Grid container columnSpacing={5} rowSpacing={5} sx={{ marginTop: "80px" }}>
                        <Grid item xs={12} sm={6} lg={3}>
                            <Box className={styles.cardBox} sx={{ backgroundColor: "#ebf4f7", padding: "5% 2% 20% 6%", height: "200px" }}>
                                <Typography sx={{ fontSize: mobile ? '16px' : '22px', fontWeight: 'bold' }}>Office of the Executive Director</Typography>
                                <Box className={styles.fadeInUp}
                                    ...
                                    <span className={styles.hline1}></span><Link href="javascript:;" className={styles.link}>
                                        <Typography sx={{ fontSize: mobile ? '16px' : '18px' }}>Office of the Executive Director</Typography></Link>
                                </Box>
                        ...
                        <table className={styles.table}>
                            <tbody>
                                <tr className={styles.row}>
                                    <td className={styles.data}><Link className={styles.link} href="javascript:;"> <Typography sx={{ fontSize: "14px" }}>
                                        Rules of the Police Commission</Typography></Link></td>

                                </tr>
                                <tr className={styles.row}>
                                    <td className={styles.data}><Typography sx={{ fontSize: "14px" }}>Tow Truck Complaint Hotline <Link className={styles.link} href="javascript:;">323-680-4869</Link> 323-680-4-TOW (4869)</Typography></td>

                                </tr>
                                <tr className={styles.row}>
                                    <td className={styles.data}>
                                        <Link className={styles.link} href="javascript:;"><Typography sx={{ fontSize: "14px" }}>Policy Regarding Commission and Department Discussion Time Limits</Typography></Link>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <Box sx={{ marginTop: "60px" }}>
                    <Grid container columnSpacing={5} rowSpacing={5}>
                        <Grid item sm={6} md={6} lg={6}>
                            <Box sx={{ backgroundColor: "#ebf4f7", padding: "3% 3% 3% 3%" }}>
