                ...
                <Box sx={{ backgroundColor: "#052942", display: "flex", flexDirection: "column", gap: "20px", padding: "5%" }}>
                  <Box sx={{ display: "flex", flexDirection: "row", gap: "15px" }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                      ...
                      <Link href="javascript:;" style={{ textDecoration: 'none' }}><Typography sx={{ color: "#ffffff", fontSize: "22px" }}>9-1-1</Typography></Link>
                    </Box>
                  ...
                  <Box sx={{ display: "flex", flexDirection: "row", gap: "15px" }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                      ...
                      <Link href="javascript:;" style={{ textDecoration: 'none' }}><Typography sx={{ color: "#ffffff", fontSize: "22px" }}>1-877-ASK-LAPD</Typography></Link>
                    </Box>
